                ...
                if (!res.data.code == 0) {
                    ...
                    wx.cloud.callContainer({
                        ...
                        "data": {
                            ...
                            "passwd": passwd,
                            "resume": resume,
                            "img_url": "cloud://prod-9gy59jvo10e0946b.7072-prod-9gy59jvo10e0946b-1310014865/a11smile/gainers/0x5f28756C07D1EABd06190cd31822d16c2Da7C113/Image/1651336988.jpg",
                        },
                        success: function (res) {
                            if (res.data.code == 0) {
                                wx.showToast({
                                    ...
                                    success: function () {
                                        setTimeout(
                                            function () {
                                                wx.navigateTo({
                                                    url: '/pages/gainer_login/gainer_login',
                                                })
                                            }, 1000)
                                    }
                                })
                                ...
                                wx.showToast({
                                    ...
                                    success: function () {
                                        setTimeout(
                                            function () {
                                                wx.navigateTo({
                                                    url: '/pages/gainer_bizlicense/gainer_bizlicense',
                                                })
                                            }, 1000)
                                    }
                                })
