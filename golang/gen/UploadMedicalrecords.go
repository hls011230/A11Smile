...
var UploadMedicalrecordsMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[{\"internalType\":\"address\",\"name\":\"user\",\"type\":\"address\"},{\"internalType\":\"string\",\"name\":\"Proute\",\"type\":\"string\"}],\"name\":\"AddMedicalInformation\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"_user\",\"type\":\"address\"}],\"name\":\"Adduser\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"_user\",\"type\":\"address\"}],\"name\":\"IsUser\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"lastUpdateTime\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"_user\",\"type\":\"address\"}],\"name\":\"ViewMedicalRecords\",\"outputs\":[{\"internalType\":\"string[]\",\"name\":\"\",\"type\":\"string[]\"}],\"stateMutability\":\"view\",\"type\":\"function\"}]",
}
...
// IsUser is a free data retrieval call binding the contract method 0x1363a1af.
//
// Solidity: function IsUser(address _user) view returns(bool)
func (_UploadMedicalrecords *UploadMedicalrecordsCaller) IsUser(opts *bind.CallOpts, _user common.Address) (bool, error) {
	var out []interface{}
	err := _UploadMedicalrecords.contract.Call(opts, &out, "IsUser", _user)
...
//
// Solidity: function IsUser(address _user) view returns(bool)
func (_UploadMedicalrecords *UploadMedicalrecordsSession) IsUser(_user common.Address) (bool, error) {
	return _UploadMedicalrecords.Contract.IsUser(&_UploadMedicalrecords.CallOpts, _user)
}

// IsUser is a free data retrieval call binding the contract method 0x1363a1af.
//
// Solidity: function IsUser(address _user) view returns(bool)
func (_UploadMedicalrecords *UploadMedicalrecordsCallerSession) IsUser(_user common.Address) (bool, error) {
	return _UploadMedicalrecords.Contract.IsUser(&_UploadMedicalrecords.CallOpts, _user)
}

// ViewMedicalRecords is a free data retrieval call binding the contract method 0x63913094.
//
// Solidity: function ViewMedicalRecords(address _user) view returns(string[])
func (_UploadMedicalrecords *UploadMedicalrecordsCaller) ViewMedicalRecords(opts *bind.CallOpts, _user common.Address) ([]string, error) {
	var out []interface{}
	err := _UploadMedicalrecords.contract.Call(opts, &out, "ViewMedicalRecords", _user)
...
//
// Solidity: function ViewMedicalRecords(address _user) view returns(string[])
func (_UploadMedicalrecords *UploadMedicalrecordsSession) ViewMedicalRecords(_user common.Address) ([]string, error) {
	return _UploadMedicalrecords.Contract.ViewMedicalRecords(&_UploadMedicalrecords.CallOpts, _user)
}

// ViewMedicalRecords is a free data retrieval call binding the contract method 0x63913094.
//
// Solidity: function ViewMedicalRecords(address _user) view returns(string[])
func (_UploadMedicalrecords *UploadMedicalrecordsCallerSession) ViewMedicalRecords(_user common.Address) ([]string, error) {
	return _UploadMedicalrecords.Contract.ViewMedicalRecords(&_UploadMedicalrecords.CallOpts, _user)
}
...
// AddMedicalInformation is a paid mutator transaction binding the contract method 0xbc41f581.
//
// Solidity: function AddMedicalInformation(address user, string Proute) returns()
func (_UploadMedicalrecords *UploadMedicalrecordsTransactor) AddMedicalInformation(opts *bind.TransactOpts, user common.Address, Proute string) (*types.Transaction, error) {
	return _UploadMedicalrecords.contract.Transact(opts, "AddMedicalInformation", user, Proute)
}

// AddMedicalInformation is a paid mutator transaction binding the contract method 0xbc41f581.
//
// Solidity: function AddMedicalInformation(address user, string Proute) returns()
func (_UploadMedicalrecords *UploadMedicalrecordsSession) AddMedicalInformation(user common.Address, Proute string) (*types.Transaction, error) {
	return _UploadMedicalrecords.Contract.AddMedicalInformation(&_UploadMedicalrecords.TransactOpts, user, Proute)
}

// AddMedicalInformation is a paid mutator transaction binding the contract method 0xbc41f581.
//
// Solidity: function AddMedicalInformation(address user, string Proute) returns()
func (_UploadMedicalrecords *UploadMedicalrecordsTransactorSession) AddMedicalInformation(user common.Address, Proute string) (*types.Transaction, error) {
	return _UploadMedicalrecords.Contract.AddMedicalInformation(&_UploadMedicalrecords.TransactOpts, user, Proute)
}

// Adduser is a paid mutator transaction binding the contract method 0x5a4670e7.
//
// Solidity: function Adduser(address _user) returns()
func (_UploadMedicalrecords *UploadMedicalrecordsTransactor) Adduser(opts *bind.TransactOpts, _user common.Address) (*types.Transaction, error) {
	return _UploadMedicalrecords.contract.Transact(opts, "Adduser", _user)
}

// Adduser is a paid mutator transaction binding the contract method 0x5a4670e7.
//
// Solidity: function Adduser(address _user) returns()
func (_UploadMedicalrecords *UploadMedicalrecordsSession) Adduser(_user common.Address) (*types.Transaction, error) {
	return _UploadMedicalrecords.Contract.Adduser(&_UploadMedicalrecords.TransactOpts, _user)
}

// Adduser is a paid mutator transaction binding the contract method 0x5a4670e7.
//
// Solidity: function Adduser(address _user) returns()
func (_UploadMedicalrecords *UploadMedicalrecordsTransactorSession) Adduser(_user common.Address) (*types.Transaction, error) {
	return _UploadMedicalrecords.Contract.Adduser(&_UploadMedicalrecords.TransactOpts, _user)
}
