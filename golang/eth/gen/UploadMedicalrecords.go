...
// GetUserETH is a free data retrieval call binding the contract method 0x2bcc7211.
//
// Solidity: function getUserETH(address user) view returns(uint256)
func (_UploadMedicalrecords *UploadMedicalrecordsCaller) GetUserETH(opts *bind.CallOpts, user common.Address) (*big.Int, error) {
	var out []interface{}
	err := _UploadMedicalrecords.contract.Call(opts, &out, "getUserETH", user)
...
//
// Solidity: function getUserETH(address user) view returns(uint256)
func (_UploadMedicalrecords *UploadMedicalrecordsSession) GetUserETH(user common.Address) (*big.Int, error) {
	return _UploadMedicalrecords.Contract.GetUserETH(&_UploadMedicalrecords.CallOpts, user)
}

// GetUserETH is a free data retrieval call binding the contract method 0x2bcc7211.
//
// Solidity: function getUserETH(address user) view returns(uint256)
func (_UploadMedicalrecords *UploadMedicalrecordsCallerSession) GetUserETH(user common.Address) (*big.Int, error) {
	return _UploadMedicalrecords.Contract.GetUserETH(&_UploadMedicalrecords.CallOpts, user)
}
